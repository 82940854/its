    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        v: "3.1.1", ie: function () {
            ...
            var cancelFunction = function () {
                ...
                var item = $('.layui-form-checked');
                item.each(function () {
                    $(this).click();
                })
            }
            n = n?n:cancelFunction;
            a = a?a:cancelFunction;
        ...
        var t = this;
        if(e&&e.content&&e.type==2){
            //layer.open iframe层添加access_token
            var _url = e.content;
            if(_url.indexOf('access_token')==-1){
                var  token = sessionStorage.getItem('access_token');
                if (_url.indexOf("?") != -1) {
                    e.content = e.content + "&access_token=" + token;
                } else {
                    e.content = e.content + "?access_token=" + token;
                }
            }
